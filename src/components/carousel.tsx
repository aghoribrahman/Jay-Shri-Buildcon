    ...
    <div className="py-12 px-6 mt-20">
      <div className="container mx-auto md:max-w-[1200px]">
        <h1 className="font-semibold text-4xl lg:text-6xl max-w-2xl leading-snug">
          Clients Success <span className="text-yellow-500">Stories</span>
        </h1>
        <p className="text-lg text-secondary-content max-w-2xl mt-2 leading-tight">
        Discover how Jay Shri Buildicon has transformed 
        infrastructure development with exceptional project execution. 
        Hear directly from our clients about their success and 
        satisfaction with our reliable and efficient construction solutions.
        </p>
